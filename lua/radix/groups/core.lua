...
function M.get(c, opts)
  ...
  return {
    ...
    MatchParen = { fg = c.blue, bg = c.bg_highlight, bold = true },
    ...
    TabLineSel = { fg = c.blue, bg = c.bg_highlight, bold = true },
    ...
    PmenuMatch = { fg = c.blue, bg = c.bg_popup },
    PmenuSel = { fg = c.fg, bg = c.bg_visual },
    PmenuMatchSel = { fg = c.blue, bg = c.bg_visual, bold = true },
    PmenuSbar = { bg = c.palette.slate[3] },
    PmenuThumb = { bg = c.palette.slate[7] },
    ...
    LspInlayHint = { fg = c.palette.slate[9], bg = c.palette.slate[2] },
