...
function M.get(c)
  local groups = {
    ...
    SnacksTitle = { fg = c.border_highlight, bg = c.bg_highlight, bold = true },
    SnacksPicker = { fg = c.fg, bg = c.bg_highlight },
    SnacksPickerTitle = "SnacksTitle",
    ...
    SnacksPickerListNormalFloat = { fg = c.fg, bg = c.bg_highlight },
    SnacksPickerPreviewNormalFloat = { fg = c.fg, bg = c.bg_highlight },
    SnacksPickerBoxNormalFloat = { fg = c.fg, bg = c.bg_highlight },
    SnacksPickerBorder = { fg = c.border_highlight, bg = c.bg_highlight },
